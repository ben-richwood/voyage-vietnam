...
<div class="right-page book-content">
  <div class="inner-page">
    ...
    <button class="button-images" data-card="8">Voir les photos</button>
  </div>
</div>
...
<div class="right-page book-content">
  <div class="inner-page">
    ...
    <button class="button-images" data-card="12">Voir les photos</button>
  </div>
</div>
<div class="left-page"></div>
<div class="right-page book-content">
  <div class="inner-page">
    <h1>En direction de Dong Van - Le sentier dans les montagnes</h1>
    <em>10 juin</em>
    <p>La pluie accompagne notre route en direction du nord. On passe plusieurs cols, en s'arrêtant pour des cafés. Les lacets sont gras et glissants avec la pluie, nous invitant à ralentir.</p>
    <picture>
      <source type="image/webp" srcset="./img/pics/three.webp">
      <source type="image/jpg" srcset="./img/pics/three.png">
...
<div class="right-page book-content">
  <div class="inner-page">
    <h1>Dong Van et ses rizières</h1>
    <em>12 juin</em>
...
<div class="right-page book-content">
  <div class="inner-page">
    ...
    <button class="button-images" data-card="22">Voir les photos</button>
  </div>
</div>
...
<div class="right-page book-content">
  <div class="inner-page">
    ...
    <button class="button-images" data-card="26">Voir les photos</button>
  </div>
</div>
